 ...
 */
type MutableAttrs = {
    -readonly [P in keyof Attrs]: Attrs[P];
};
/**
 * @public
 */
 ...
 * @public
 */
declare function selectionCell(state: EditorState): ResolvedPos | null | undefined;
/**
 * @public
 */
 ...
 * @public
 */
declare function inSameTable($a: ResolvedPos, $b: ResolvedPos): boolean;
/**
 * @public
 */
 ...
 * @public
 */
declare function nextCell($pos: ResolvedPos, axis: string, dir: number): null | ResolvedPos;
/**
 * @public
 */
declare function removeColSpan(attrs: Attrs, pos: number, n?: number): Attrs;
/**
 * @public
 */
declare function addColSpan(attrs: Attrs, pos: number, n?: number): Attrs;
/**
 * @public
 */
...
declare class CellSelection extends Selection {
    ...
    static colSelection($anchorCell: ResolvedPos, $headCell?: ResolvedPos | null): CellSelection;
    isRowSelection(): boolean;
    eq(other: unknown): boolean;
    static rowSelection($anchorCell: ResolvedPos, $headCell?: ResolvedPos | null): CellSelection;
    toJSON(): CellSelectionJSON;
    static fromJSON(doc: Node, json: CellSelectionJSON): CellSelection;
    static create(doc: Node, anchorCell: number, headCell?: number | null): CellSelection;
 ...
 * @internal
 */
declare function pastedCells(slice: Slice): Area | undefined;
/**
 ...
 * @public
 */
type getFromDOM = (dom: HTMLElement) => any;
/**
 * @public
 */
type setDOMAttr = (value: any, attrs: MutableAttrs) => void;
/**
 * @public
 */
 ...
 * @public
 */
declare function tableNodeTypes(schema: Schema): Record<TableRoles, NodeType>;
